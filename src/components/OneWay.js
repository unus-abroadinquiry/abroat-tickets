...
const OneWay = () => {
  ...
  }, [adultCount, childCount, kidsCount, bookingClass, infantCount]);
  ...
  return (
    <>
      ...
      <form key="handleSubmit" onSubmit={formik.handleSubmit}>
        <div className="flex flex-col sm:flex-col">
          <div className="flex flex-col sm:flex-row">
            <div className="w-[300px] sm:w-[340px]  flex flex-col border border-indigo-600 p-2 rounded-md">
            ...
            <div className="w-[300px] sm:w-[340px] mt-2 sm:mt-0 flex flex-col border border-indigo-600 p-2 rounded-md sm:ml-4">
              <label className="font-bold ml-2 font-Monserrat">
                Phone Number
              </label>
              <input
          ...
          <div className="flex flex-col sm:flex-row mt-4 ">
            ...
            <div className="w-[300px] sm:w-[340px] mt-2 sm:mt-0 flex flex-col border border-indigo-600 p-2 rounded-md sm:ml-4">
              ...
              <Popover
                placement="bottom"
                isOpen={openTo}
                onOpenChange={(openTo) => setOpenTo(openTo)}
                showArrow={true}
              >
                <PopoverTrigger>
                  <div
